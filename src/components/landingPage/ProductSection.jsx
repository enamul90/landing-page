                ...
                [1,1,1,].map((item, index) => (
                    <div key={index} className={"p-4 bg-Shave border border-Line rounded gap-6 items-center md:flex space-y-10 md:space-y-0"}>
                        ...
                        <div className={"space-y-4"}>
                            <div>
                                <h2 className={"md:text-xl text-lg text-Text-100 font-semibold  "}>প্রিমিয়াম কোয়ালিটির বোরকাটি পাচ্ছেন এখন ৪৭% ডিসকাউন্ট। প্রিমিয়াম কোয়ালিটির কাপড় এবং অরজিনাল </h2>
                                <p className={"mt-2 text-Text-75 font-medium md:text-base text-ms "}>ভাসমান ফুল এবং একটি মনোমুগ্ধকর ফিট-এন্ড-ফ্লেয়ার সিলুয়েট এই সবুজ টায়ার্ড মিডিকে একটি মার্জিত পছন্দ করে তুলেছে। একটি বহুমুখী বিকল্প, মোটা ট্রেইনার বা স্ট্র্যাপি স্যান্ডেল পরে পরুন। </p>
                            </div>
