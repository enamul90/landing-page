...
const CheckoutSection = ({
  ...
  return (
    <div className="py-5">
      ...
      >
        <div className="p-3 lg:p-6 border-2 border-t-8 border-[#000000] rounded-xl bg-white">
          ...
          <div id="card" className="grid lg:grid-cols-2 gap-6 pb-5 mt-6">
            ...
            <div>
              ...
              <button
                ...
                className="lg:p-3 p-2 bg-[#008D14] w-full rounded mt-6 text-white font-semibold cursor-pointer"
              >
