...
const CheckoutSection = ({
  ...
  return (
    <div className="bg-[#FFEEDD] py-10">
      <div
        className={
          "container mx-auto max-w-6xl px-3  mt-3 lg:space-y-4 space-y-3"
        }
      >
        <div className="mt-5 p-3 lg:p-6 border-2 border-[#CE2127] rounded-xl bg-white">
          <h2 className="lg:text-4xl md:text-xl text-lg text-[#CC2127] font-bold text-center mb-5">
            {title || "অর্ডার করতে নিচের ফর্মটি পূরন করুন"}
          </h2>
          <h5 className="text-Text-100 md:text-lg font-bold">
                ...
                {checkoutData.shippingCosts.map((shipping, index) => (
                  <div key={index} className="flex gap-3 items-center">
                    <input
                      ...
                      onChange={() =>
                        handleChange("shippingCost", shipping.cost)
                      }
                    />
            ...
            <div>
              ...
              {cartProducts
                ...
                .map((item) => (
                  <div
                    key={item._id}
                    className="flex gap-3 md:items-center mb-2"
                  >
              ...
              <button
                ...
                className="lg:p-3 p-2 bg-[#CE2127] w-full rounded mt-6 text-white font-semibold cursor-pointer"
              >
                {orderloading ? "Processing Order.." : "অর্ডার করুন"} {payable}{" "}
                TK
              </button>
            </div>
          </div>
